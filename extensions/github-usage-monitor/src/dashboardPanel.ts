...
function actions(): string { return `<div class="actions"><button data-command="refresh">Refresh now</button><button data-command="manualEntry">Enter allowances</button><button data-command="settings">Settings</button><button class="secondary" data-command="clearData">Clear data</button></div>`; }
