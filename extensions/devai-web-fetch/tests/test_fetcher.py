...
async def test_redirect_to_loopback_blocked_per_hop(
    ...
    from devai_web_fetch.ssrf_guard import validate_url
...
async def test_max_redirects_exceeded_raises(
    ...
    from devai_web_fetch.fetcher import FetchError
...
async def test_dns_pinning_context_manager(permissive_config: GuardConfig) -> None:
    ...
    from devai_web_fetch.ssrf_guard import pin_hostname_to_ip
    ...
    import devai_web_fetch.ssrf_guard as guard
