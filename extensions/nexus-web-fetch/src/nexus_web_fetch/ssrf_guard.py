"""SSRF protection for nexus-web-fetch.
...
YAML config override at ~/.nexus/web-fetch.yaml for explicit allow/deny
rules.
"""
...
CONFIG_PATH = Path.home() / ".nexus" / "web-fetch.yaml"
...
@dataclass
class GuardConfig:
    """User-configurable SSRF policy loaded from ~/.nexus/web-fetch.yaml."""
