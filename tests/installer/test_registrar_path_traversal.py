...
Related plan reference: docs/v2.1.0/plans/adoption-spec-kit.md (Phase 9
...
docs/v2.0.0/comparison-spec-kit.md, not in the artifact itself.
"""
...
class TestRejectMaliciousNames:
    """Cases 1-4 from docs/v2.1.0/plans/adoption-spec-kit.md sub-task 9.4."""
