...
cp catalogs/claude_skills/infrastructure/kubernetes-expert/SKILL.md .claude/skills/
```
...
cp catalogs/claude_skills/infrastructure/kubernetes-expert/SKILL.md .claude/skills/
cp catalogs/claude_skills/language-specialists/go-expert/SKILL.md .claude/skills/
```
...
cp -r catalogs/claude_skills/infrastructure .claude/skills/

# Copy all orchestration skills
cp -r catalogs/claude_skills/orchestration .claude/skills/
```
...
```markdown
## Skills Reference
See: @../ai-templates/catalogs/claude_skills/ for available skills
```
...
1. **Browse the catalog**: `catalogs/claude_skills/CATALOG.md`
