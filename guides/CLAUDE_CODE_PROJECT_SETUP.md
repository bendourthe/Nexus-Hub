...
- Access to this ai-templates repository
...
The `/import-skills` command lets you interactively select and import skills from the ai-templates catalog - choose all, by category, or specific skills.
