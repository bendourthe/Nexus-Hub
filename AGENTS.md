...
Current catalog: **253 skills** across 21 categories, 15 commands (plus 3 permanent aliases), 22 hooks, 23 agents. The 40 v3.x deprecation shims were removed in v3.2.0.
...
│   └── skills/               # 253 skills across 21 categories
│       └── <category>/
│           └── <skill-name>/
│               └── SKILL.md
...
- **Behavioral-guardrails only**: OpenCode (`AGENTS.md`).
