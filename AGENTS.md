...
Current catalog: **327 skills** across 23 categories, 18 commands (plus 3 permanent aliases), 33 hooks, 23 agents. The 40 v3.x deprecation shims were removed in v3.2.0.
...
|   `-- skills/               # 327 skills across 23 categories
│       └── <category>/
│           └── <skill-name>/
│               └── SKILL.md
