...
Current catalog: **268 skills** across 21 categories, 16 commands (plus 3 permanent aliases), 28 hooks, 23 agents. The 40 v3.x deprecation shims were removed in v3.2.0.
...
│   └── skills/               # 268 skills across 21 categories
│       └── <category>/
│           └── <skill-name>/
│               └── SKILL.md
