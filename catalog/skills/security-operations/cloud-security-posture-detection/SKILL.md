...
- Writing or applying Terraform, Bicep, or other IaC to provision or fix resources. Use [[terraform-specialist]].
...
- [ ] Findings are ranked by exposure and blast radius and each carries a remediation owner.
