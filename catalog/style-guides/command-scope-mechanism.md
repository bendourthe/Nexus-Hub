...
The full design rationale is in [`docs/v3.0.0/command-consolidation-design.md`](../../docs/v3.0.0/command-consolidation-design.md) Section 4. This file is the distributable, command-author-facing version of that contract. It installs to `~/.nexus-hub/style-guides/command-scope-mechanism.md`.
