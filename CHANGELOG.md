...
- **Interactive guide visual education (v4.2.1, in progress).** Phase 1 local: working contract supersedes the unpublished v4.2.0 teaching freeze (slides inside Training, cinematic CSS/JS patterns without video, Cheatsheets, Glow Booth). Guide HTML is unchanged until Phase 2.
