...
- **`interface-review` skill.** Coordinating review: fixed domain order, canonical rule-ownership table, missing-delegate honesty, Considered-but-Rejected, and a quick/full finding cap. Read-only by default.
