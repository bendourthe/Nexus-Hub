...
**v3.15.4 presentify-visual-fidelity (in progress).** Making the presentify skill's output visually faithful and self-correcting. Phases 1-4 land the full-width canvas contract, measurable image-sizing discipline, annotated-figure overlay recreation, and reliable stock/mix imagery integration; Phases 5-7 (the iterative visual-QA loop, polish, and the refactor gate) follow. No version surface is bumped until release. Catalog counts unchanged: **268 skills**, **16 commands**, **28 hooks**.
