...
- **Plan-driven docs**: `docs/v1.3.0/plans/adoption-pm-claude-skills.md` finalized (all 6 phase exit checklists ticked); `docs/v1.3.0/comparison-pm-claude-skills.md` is the source-of-truth for the adoption decisions; `docs/v1.3.0/known-gaps.md` updated with Phase 6 close (no new gaps introduced).
