...
3. **T042 -- Close NI-v24-1.** Confirmed the convention-based decision to keep `validate_solution_frontmatter.py` as a single cross-platform `.py` validator (no `.ps1` sibling) and recorded it as won't-do in `docs/v3.0.0/known-gaps.md`.
