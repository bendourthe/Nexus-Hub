...
- [ ] Publish the v4.0 contract-and-audit disposition and verify post-merge checks; the local committed-tree detector now reports exactly the two historical plans in v4.0.
