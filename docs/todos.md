...
- [ ] Prove the protected merge gate with a docs-only pull request that reports all five required contexts and cannot merge while they are pending, then verify post-merge smoke and provenance.
