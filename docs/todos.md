...
- [ ] Classify the post-publication v4.0 lifespan findings for the frozen lifecycle contract, final audit, and two plans; resolve the CI plan's 62-box retention disposition before closing WN-2.
