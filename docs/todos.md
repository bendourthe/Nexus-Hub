...
- [x] Merge PR #252 without bypass and verify post-merge smoke and provenance at `a15141fd` in run 35889175597; remove its clean temporary worktree and merged local branch.
- [x] Locally qualify v4.8 MT-1: 12 capture-helper tests passed with 95% focused statement coverage; both visual-regression script suites passed 19/19, and installed Chrome produced a valid PNG from a local HTML page.
- [ ] Publish the v4.8 MT-1 test and ledger follow-up through a protected PR and verify its post-merge result.
