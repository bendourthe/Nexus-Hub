...
All five phases complete; merged to `develop` via PR #123. Outcome in [`docs/releases/v4/v4.0/known-gaps.md`](releases/v4/v4.0/known-gaps.md).

---

## Plan - v4.0.0 Cost-Effective CI/CD [DONE]

All eight phases complete; merged to `develop` via PR #124 with follow-up PR #125. Outcome in [`docs/releases/v4/v4.0/known-gaps.md`](releases/v4/v4.0/known-gaps.md).

---

## Carried gaps under active consideration

- [ ] **v3.21 DF-1** - no product atlas HTML under `docs/handbooks/`. Deliberately not invented; needs real authored content before generation is meaningful. See [`docs/releases/v3/v3.21/known-gaps.md`](releases/v3/v3.21/known-gaps.md).
