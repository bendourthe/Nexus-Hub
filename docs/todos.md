...
**Closeout update:** PRs #248, #249, and #250 passed hosted and post-merge checks. The v4.12 BG-3 shared-hook defect is resolved after worktree removal and a negative trailer probe. The main checkout's 47 pre-existing user-owned changes, three future-plan branches, retained recovery backups, and bounded known gaps still prevent a clean-slate claim.
