...
- [ ] Classify the four remaining post-tag v4.0 lifespan-detector findings, resolve each plan and operational document against retention policy, and close v4.0 WN-2 only after a defensible baseline is verified.
