...
- [ ] Classify the five post-tag v4.0 lifespan-detector findings on `origin/develop`, reconcile the active known-gaps and live-document retention rules with the detector, and close v4.0 WN-2 only after a defensible baseline is verified.
