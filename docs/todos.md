...
- [ ] Qualify the Haiku 4.5 extended-thinking candidate against a complete live Claude model-ID roster and write it through the deterministic profile writer; keep v4.9 MT-1 open until that profile and the three GPT-5.6 entries have honest dispositions.
