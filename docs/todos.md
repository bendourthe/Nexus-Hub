...
- [ ] Complete v4.9 MT-1's live Claude roster freshness and publish the three GPT-5.6 profiles through protected integration. The Haiku 4.5 claim-only profile was published through [PR #314](https://github.com/bendourthe/Nexus-Hub/pull/314); the recorded roster still carries its 2026-09-08 date.
