...
- [ ] Publish and verify the v4.12 WN-4 Windows settings-replacement repair. The held-handle failure class is reproduced and the local candidate is recorded in the [archived qualification](archives/v4/v4.12/development/wn4-atomic-replace/verification.md); the original denying process remains unknown.
