...
- [ ] Complete v4.9 MT-1's live-roster freshness and three GPT-5.6 profile dispositions. The Haiku 4.5 claim-only profile was published through [PR #314](https://github.com/bendourthe/Nexus-Hub/pull/314): 21 hosted checks passed with one intentional skip, and [post-merge run 36137890656](https://github.com/bendourthe/Nexus-Hub/actions/runs/36137890656) passed smoke and provenance. The structural gate reports 13 of 16 rostered models profiled while retaining the 2026-09-08 roster stamp; see the [bounded local verification](archives/v4/v4.9/development/haiku-profile-claim-only-2026-09-25/verification.md).
