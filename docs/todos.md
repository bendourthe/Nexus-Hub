...
**Active work:** v4.9.1 interactive handbooks is implementing Phase 5 after verified conditional intake, dual-view assembly and isolated installer tests. Existing guide work retains its separate owner. The application-security audit is released in v4.9.0; see its [release evidence](releases/v4/v4.9/development/history/2026-09-08_v4.9.0-release.md) and [final release handoff](https://github.com/bendourthe/Nexus-Hub/pull/192).
