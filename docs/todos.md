...
- [ ] Publish the qualified Haiku 4.5 claim-only profile through a protected PR: local writer and structural checks now report 13 of 16 rostered models profiled without changing the 2026-09-08 roster stamp. The complete live Claude roster remains unavailable, and v4.9 MT-1 stays open for that freshness gate and the three GPT-5.6 entries. Archive the [bounded local verification](archives/v4/v4.9/development/haiku-profile-claim-only-2026-09-25/verification.md).
