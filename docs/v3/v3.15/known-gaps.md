...
**Status**: IN PROGRESS. Phases 1-2 of 3 COMPLETE; Phase 3 pending. This section is appended per-phase and finalized at the v3.15.3 release (Phase 3). Plan: [plans/v3.15.3-adoption-no-ai-slop.md](plans/v3.15.3-adoption-no-ai-slop.md).
