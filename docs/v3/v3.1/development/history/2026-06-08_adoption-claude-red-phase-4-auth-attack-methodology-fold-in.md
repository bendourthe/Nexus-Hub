...
**Date**: 2026-06-08
**Plan**: [`docs/v3/v3.1/plans/adoption-claude-red.md`](../../plans/adoption-claude-red.md)
...
See [`docs/v3/v3.1/known-gaps.md`](../../known-gaps.md). 1 new open item this phase (WN-v31cr-5: the enriched body is 903 lines, over the 800-line hard cap -- grandfathered, deep detail externalized, future split recommended), 0 resolved. WN-v31cr-1 was extended to record the fifth >250-char pushy description and its allowlist registration. Carried forward: WN-v31cr-1/-2/-3/-4. Total 5 WN open.
