...
**Project**: Nexus-Hub
**Status**: v3.17.3 is released, and v3.17.4 Org Knowledge Layer implementation is in progress with Phases 1 through 4 completed. Phase 4 adds no new open gap; the existing local Windows integration-suite runtime warning remains non-blocking, and there is no release blocker. Prior v3.17.0 through v3.17.3 records remain below.
**Last updated**: 2026-08-16 (v3.17.4 Phase 4 Guided Authoring Surface)
...
**Status**: Phases 1 through 4 completed on 2026-08-16 with 1 open non-blocking warning, 0 resolved items, and 0 release blockers. Plan: [plans/v3.17.4-org-knowledge-layer.md](plans/v3.17.4-org-knowledge-layer.md).
