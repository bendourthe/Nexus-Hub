...
See [`docs/v3/v3.4/known-gaps.md`](../../known-gaps.md). No new gaps introduced this phase. WN-v33-1 re-confirmed (local `make`/ShellCheck unavailable; validators run directly). DF-v34-1 and WN-v33-2 carried forward, untouched by this phase.
