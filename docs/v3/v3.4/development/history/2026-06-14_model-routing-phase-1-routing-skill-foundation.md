...
**Date**: 2026-06-14
**Plan**: [`docs/v3/v3.4/plans/model-routing.md`](../../plans/model-routing.md)
...
See [`docs/v3/v3.4/known-gaps.md`](../../known-gaps.md). Three open items: DF-v34-1 (helper ShellCheck/pytest gate deferred to Phase 2.4), WN-v33-1 (local `make`/ShellCheck unavailable; validators run directly), WN-v33-2 (benign pre-existing global-audit warnings outside this work). No resolved items yet.
