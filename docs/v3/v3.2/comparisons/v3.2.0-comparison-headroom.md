...
| 7 | Token-savings benchmark / eval harness | `headroom/evals/` (GSM8K, TruthfulQA, SQuAD, BFCL) | `docs/archive/v2/v2.2.0/eval-baseline.md` + `skill-eval-loop` (skill-quality, not compression) | Partial -- methodology exists, no compression-accuracy harness. |
