...
**Plan**: [docs/v3/v3.14/plans/v3.14.0-codex-lb-adoption.md](../../plans/v3.14.0-codex-lb-adoption.md), Phase 1 of 6 (not the final phase)
...
- DF-1 (exact Codex-app credential path/shape unverified), DF-2 (undocumented `wham/usage` durability), MT-1 (UI modules untested without a VS Code host), QG-1 (extension not in CI). See [docs/v3/v3.14/known-gaps.md](../../known-gaps.md).
