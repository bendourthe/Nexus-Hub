...
**Plan**: [docs/v3/v3.14/plans/v3.14.0-codex-lb-adoption.md](../../plans/v3.14.0-codex-lb-adoption.md), Phase 4 of 6 (not the final phase)
...
- BG-1 (pre-existing installer-registration failure for `verify_platform_contracts.py`; fix separately or in Phase 6.3). HO-1 (review-trapdoors skill-name collision) still pending Phase 6.4. See [docs/v3/v3.14/known-gaps.md](../../known-gaps.md).
