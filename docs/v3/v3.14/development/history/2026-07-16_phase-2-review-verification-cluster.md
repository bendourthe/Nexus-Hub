...
**Plan**: [docs/v3/v3.14/plans/v3.14.0-codex-lb-adoption.md](../../plans/v3.14.0-codex-lb-adoption.md), Phase 2 of 6 (not the final phase)
...
- HO-1 now engages: the flat/nested skill-name-collision check applies to `review-trapdoors`, to be verified in the Phase 6.4 dry-run install. See [docs/v3/v3.14/known-gaps.md](../../known-gaps.md).
