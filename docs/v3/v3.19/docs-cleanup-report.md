...
All v3.19 artifacts remain active. v3.19.2 Phase 5 is complete. No file move, rename, archive, or deletion is proposed.
...
| `development/history/` | 4 | 20 | Seven v3.19.0 histories, eight v3.19.1 write-ups, plus five v3.19.2 phase write-ups |
| `design/` | 4 | 1 | v3.19.2 signed-execution-contract study |
| `known-gaps.md` | 4 | 1 | v3.19.2 subsection (DF-1, DF-2, DF-3); v3.19.1 BG-1 remains until the next patch |
