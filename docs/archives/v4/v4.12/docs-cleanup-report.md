...
|---|---|---|
| `docs/archives/v4/v4.12/development/attribution-inventory.md` | Cat 4 | Active release evidence; preserve in place. |
...
Retain `docs/archives/v4/v4.12/{plans,development,known-gaps.md,docs-cleanup-report.md}` and the proposed process decision. Living DEVLOG/todos remain in place.
