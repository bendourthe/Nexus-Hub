...
| v4.4.6-guide-learning-experience.md | Declared closed | Excluded | SUPERSEDED BY USER. The content/structure redesign was rejected; v4.4.5 is restored. Do not resume this plan. See the [corrected visual scope](../../../../releases/v4/v4.4/development/guide-learning-experience/restoration/verification.md). |
