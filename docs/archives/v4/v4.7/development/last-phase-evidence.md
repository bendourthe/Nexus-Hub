...
**Date**: 2026-09-05
**Plans**: `docs/archives/v4/v4.7/plans/v4.7.0-adoption-model-behavior-and-distribution-integrity.md` (main, Phase 7 of 7) and `v4.7.0-adoption-gpt-6-astra-prompting.md` (amendment, Phase 4 discharged here with one shared evidence file, as that plan's note on Phase 4 states)
