...
**Plans**: `docs/archives/v4/v4.2/plans/v4.2.0-interactive-guide-redesign.md` (historical; unpublished) and `docs/archives/v4/v4.2/plans/v4.2.1-guide-visual-education.md` (current)
**Baseline**: `docs/archives/v4/v4.2/development/guide-redesign-baseline/`
