...
- Stay: `guides/website/nexus-hub-guide.html`; `guides/website/README.md`; `guides/website/example/training-scenes.json`; `tests/guides/test_nexus_hub_guide.py`; the v4.2 plan, content-map, baseline and per-phase evidence folders, known-gaps, docs-cleanup report, session histories, and this evidence file under `docs/archives/v4/v4.2/`.
...
The living handbook root remains a scaffold. Release-bound plan, content-map, histories, known-gaps, cleanup report, hallmark re-audit, and this evidence file remain under `docs/archives/v4/v4.2/`. `docs/decisions/` was not used for this UX redesign; the plan is the attribution record. `docs/DEVLOG.md` already has a v4.2.0 index row. `docs/todos.md` tracks this plan as the active dashboard. `docs/README.md` now names `docs/archives/v4/v4.2/` as the active 4.x minor. Root `README.md` Interactive Guide blurb matches Home / Foundations / workbench.
...
Hallmark re-audit from markup: `docs/archives/v4/v4.2/development/guide-redesign-phase-7-hallmark.md`. No open high-severity markup finding from the Phase 1 baseline table. Contrast and Lighthouse remain DF-1.
