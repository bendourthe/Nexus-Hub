...
| 20 | Mass assignment | Already Implemented | Hunter 4 ([line 356](../../catalog/commands/run-penetration-test.md#L356)) flags role fields accepted from request bodies -- the canonical mass-assignment pattern. [CATALOG-COVERAGE.md](../../../CATALOG-COVERAGE.md) lists "Mass Assignment" under Access Control Hunter. |
