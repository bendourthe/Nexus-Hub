...
- **`docs/v3.10.0/known-gaps.md`** (edited): status advanced to all-phases-complete; new DF-v310-ruflo-A10-rest for the not-adopted worker-check ideas.
- **`docs/v3.10.0/plans/adoption-ruflo.md`** (edited): Phase 6 exit checklist checked off.
...
- `docs/v3.10.0/known-gaps.md` (Phase 6 status + DF-v310-ruflo-A10-rest)
- `docs/v3.10.0/plans/adoption-ruflo.md` (Phase 6 exit checklist)
- `docs/DEVLOG.md` (Phase 6 entry)
- `docs/v3.10.0/development/history/2026-06-30_adoption-ruflo-phase-6-advisory-worker-check-hooks.md` (this file)
