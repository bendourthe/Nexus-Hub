...
- **CHANGELOG / known-gaps deferred to Phase 6.** Per the plan's phasing, `CHANGELOG.md ## [Unreleased]` and `docs/v3.10.0/known-gaps.md` are consolidated in Phase 6; Phase 2 does not touch them.
...
- `docs/v3.10.0/plans/adoption-ruflo.md` (Phase 2 exit checklist checked off)
- `docs/DEVLOG.md` (Phase 2 entry)
- `docs/v3.10.0/development/history/2026-06-30_adoption-ruflo-phase-2-prompt-injection-defense-skill.md` (this file)

## Next

Phase 3: Competitive-generation enrichment + SPARC-note decision (skill-native, P2 / optional P3). Add an iterative hill-climbing / co-evolution section to `catalog/skills/orchestration/competitive-generation/SKILL.md` (A5), and make and record an explicit build-or-skip decision on the optional named-phased-development quality-gate note (A6; recommended default: skip to `docs/v3.10.0/known-gaps.md`). No registry edit expected unless a `summary_l0` changes. CHANGELOG `## [Unreleased]` and `docs/v3.10.0/known-gaps.md` remain consolidated in Phase 6 per the plan's phasing.
