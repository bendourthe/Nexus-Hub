...
1. **Resolved the plan and phase.** Located `docs/v3.1.0/plans/adoption-dynamic-workflows.md` (legacy flat layout). Parsed the three sub-tasks and confirmed Phase 1 is non-final (1 of 3), so no release-readiness workflow runs.
...
9. **Post-phase sequence.** Checked off the plan boxes, created `docs/v3.1.0/known-gaps.md`, added a DEVLOG entry, wrote this session history, and prepared the commit message.
...
- `docs/v3.1.0/plans/adoption-dynamic-workflows.md` -- Phase 1 boxes + exit checklist checked off.
- `docs/v3.1.0/known-gaps.md` -- created (WN-v31-1).
- `docs/DEVLOG.md` -- Phase 1 entry.
- `docs/v3.1.0/development/history/2026-06-05_phase-1-workflow-bundle-convention.md` -- this file.
