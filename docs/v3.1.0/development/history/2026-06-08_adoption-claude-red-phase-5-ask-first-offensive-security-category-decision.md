...
See [`docs/v3.1.0/known-gaps.md`](../../known-gaps.md). 1 new open item this phase (WN-v31cr-6: 3 bash-installer tests fail on the Windows host due to the WSL `bash.EXE` path-resolution artifact; CI-green; Related: WN-v31cr-2), 0 resolved. Carried forward: WN-v31cr-1 through -5. Total 6 WN open. Per WN-v31cr-3 this gap log merges with the dynamic-workflows gap log at develop-integration.
