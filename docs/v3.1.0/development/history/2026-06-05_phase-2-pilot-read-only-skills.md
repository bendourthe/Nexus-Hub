...
1. **Resolved the plan, phase, and branch.** Located `docs/v3.1.0/plans/adoption-dynamic-workflows.md` (legacy flat layout); confirmed the current branch is already `feat/adoption-dynamic-workflows` with Phase 1 committed at `b7c70c2`. Parsed the three sub-tasks; Phase 2 is non-final (2 of 3), so no release-readiness workflow runs.
...
9. **Post-phase sequence.** Checked off the Phase 2 boxes + exit checklist, updated `docs/v3.1.0/known-gaps.md`, added a DEVLOG entry, wrote this session history, and prepared the commit message.
...
- `docs/v3.1.0/plans/adoption-dynamic-workflows.md` -- Phase 2 boxes + exit checklist checked off.
- `docs/v3.1.0/known-gaps.md` -- header refreshed; WN-v31-1 broadened to Phase 1-2.
- `docs/DEVLOG.md` -- Phase 2 entry.
- `docs/v3.1.0/development/history/2026-06-05_phase-2-pilot-read-only-skills.md` -- this file.
