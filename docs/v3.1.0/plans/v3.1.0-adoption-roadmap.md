...
Deferred to v3.2.0: [adoption-headroom.md](../../v3.2.0/plans/adoption-headroom.md) (7 phases, 23 tasks, `re-full` engine build).
...
- **headroom context-compression engine** -- deferred to v3.2.0 as its own focused release (large `re-full` build; different risk profile). See [`../../v3.2.0/plans/adoption-headroom.md`](../../v3.2.0/plans/adoption-headroom.md).
