...
**Date**: 2026-05-20
**Scope**: Phase 3 of [docs/v2.1.0/plans/adoption-spec-kit.md](../../plans/adoption-spec-kit.md)
...
**Plan reference**: [docs/v2.1.0/plans/adoption-spec-kit.md](../../plans/adoption-spec-kit.md) Phase 3
**Source comparison**: [docs/v2.0.0/comparison-spec-kit.md](../../../v2.0.0/comparison-spec-kit.md) adoption candidate G4
...
Before opening the implementation work, the source plan file was relocated from `docs/v2.0.0/plans/adoption-spec-kit.md` to `docs/v2.1.0/plans/adoption-spec-kit.md` so it lives in the version it targets. The relocation is recorded as a `git rm` + `git add` pair in the Phase 3 commit (file body is unchanged). Two downstream links inside `docs/v2.1.0/known-gaps.md` -- the file-level `Plan` reference and the `Plan reference` field inside the WN-1 entry -- were updated to point at the new location.
...
| `docs/v2.0.0/plans/adoption-spec-kit.md` -> `docs/v2.1.0/plans/adoption-spec-kit.md` | Relocated (body unchanged) |
| `docs/v2.1.0/known-gaps.md` | Plan link fixed; WN-1 compounded note; Phase-3-close `Last updated` |
| `docs/DEVLOG.md` | New Phase 3 entry at top |
| `docs/v2.1.0/development/history/2026-05-20_phase-3-cross-artifact-analyzer.md` | This file (session history) |
...
- Source comparison: [docs/v2.0.0/comparison-spec-kit.md](../../../v2.0.0/comparison-spec-kit.md) adoption candidate G4 (cross-artifact spec analyzer).
