...
**Date**: 2026-05-20
**Scope**: Phase 5 of [docs/v2.1.0/plans/adoption-spec-kit.md](../../plans/adoption-spec-kit.md)
...
**Plan reference**: [docs/v2.1.0/plans/adoption-spec-kit.md](../../plans/adoption-spec-kit.md) Phase 5
...
- `docs/v2.1.0/known-gaps.md` -- `Last updated` line refreshed with the Phase-5-close note; no new items added, no items resolved.
