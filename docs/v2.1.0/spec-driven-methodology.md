...
- `docs/v2.0.0/comparison-spec-kit.md` - the upstream comparison that motivated v2.1.0.
- `docs/v2.1.0/plans/adoption-spec-kit.md` - the phased implementation plan for v2.1.0 and v2.2.0.
