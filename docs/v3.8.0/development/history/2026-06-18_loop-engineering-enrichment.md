...
**Date**: 2026-06-18
**Version**: v3.8.0
**Plan**: [docs/v3.8.0/plans/adoption-ralph-claude-code.md](../../plans/adoption-ralph-claude-code.md)
**Comparison**: [docs/v3.8.0/comparison-ralph-claude-code.md](../../comparison-ralph-claude-code.md)
...
- Relocated the Ralph plan + comparison from `docs/v3.7.0/` to `docs/v3.8.0/` with full reference repair (no stale `v3.7.0` Ralph references remain).
- Closed two carried-forward known gaps: WN-v37-3 (`README_zh` counts) and WN-v33-2 (two over-limit `overview_l1` fields). See [docs/v3.8.0/known-gaps.md](../../known-gaps.md).
