...
**Date**: 2026-05-20
**Plan reference**: [docs/v2.0.0/plans/nexus-hub-rename.md](../plans/nexus-hub-rename.md) Phase 8 sub-task 8.1
...
- Intentional rename callouts (`README.md`, `CHANGELOG.md`, `docs/v2.0.0/RELEASE_NOTES.md`)
- v2.0.0 self-documenting artifacts (plans/, rename-decisions.md, rename-inventory.md, sync manifests, baselines)
- The DEVLOG entries that describe the rename effort (documented as expected in `docs/v2.0.0/known-gaps.md` Phase 7 close note)
