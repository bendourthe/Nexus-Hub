...
**Captured**: 2026-05-19
**Source plan**: `docs/v2.0.0/plans/nexus-hub-rename.md`
...
All seven forms are locked. Every artifact must use the form appropriate to its context. The variant table in `docs/v2.0.0/rename-inventory.md` Section 3 enumerates the mechanical replacements implementing this canon.
...
- Implementation map: `docs/v2.0.0/plans/nexus-hub-rename.md` (Phases 2-8).
- Mechanical variant table: `docs/v2.0.0/rename-inventory.md` Section 3.
- Pre-rename baselines: `docs/v2.0.0/baselines/{validate-skills,hook-tests,extension-tests}-pre.txt`.
