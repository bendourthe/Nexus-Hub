...
- New [Reverse-Engineering Matrix](policy/mcp-reverse-engineering-matrix.md) at `docs/policy/mcp-reverse-engineering-matrix.md` - authoritative classification of every MCP shipped or considered (18 rows).
