...
- `CHANGELOG.md`
- `docs/v3.4.0/plans/adoption-nessie-and-agency-agents.md` (Phase 3 exit checklist)
- `docs/v3.4.0/known-gaps.md` (status + WN-v33-1 Phase 3 re-confirmation)
- `docs/v3.4.0/development/2026-06-15_session-query-extension-design.md` (sub-task 3.1 design note)
- `docs/DEVLOG.md`
