...
- `CHANGELOG.md`
- `docs/v3.4.0/plans/adoption-nessie-and-agency-agents.md` (Phase 5 exit checklist)
- `docs/v3.4.0/development/history/2026-06-15_adoption-nessie-and-agency-agents-phase-5-agent-body-enrichment.md` (this file)
