...
Four live-verification gaps were re-deferred with dated reasons (all acceptable for a source release, recorded in [`docs/v2.4.0/known-gaps.md`](known-gaps.md)):
