...
**Last updated**: 2026-06-25 (v3.9.0 Phase 3)
...
- **Separate v3.9.0 plan.** [docs/v3.9.0/plans/presentify-interactive-html.md](plans/presentify-interactive-html.md) is an independent v3.9.0 plan not implemented by this adoption work; its gaps will be tracked when it is implemented.
