...
- `CHANGELOG.md`
- `docs/v3.9.0/known-gaps.md` (created)
- `docs/v3.9.0/plans/adoption-looper-and-deer-flow.md` (Phase 3 exit checklist checked off)
- `docs/v3.9.0/development/history/2026-06-25_adoption-looper-and-deer-flow-phase-3-low-priority-doctrine-notes-and-consolidation.md` (this file)
