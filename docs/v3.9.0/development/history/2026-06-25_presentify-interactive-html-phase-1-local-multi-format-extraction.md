...
- `docs/v3.9.0/known-gaps.md` (Phase 1 deferrals DF-v39-presentify-1..4 + notes added; counts updated)
- `docs/v3.9.0/plans/presentify-interactive-html.md` (Phase 1 exit checklist checked off)
- `docs/v3.9.0/development/history/2026-06-25_presentify-interactive-html-phase-1-local-multi-format-extraction.md` (this file)
