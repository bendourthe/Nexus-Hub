...
| 6 | Decline durability + consolidation | Dated RE-matrix notes for inherited drops; S8 recorded as DF; counts finalized (261/16/25); CHANGELOG; `docs/v3.11.0/known-gaps.md` created with the three carried v3.10.0 items; full validator chain green | Strong reasoning tier, medium effort (Claude Code: Opus 4.8, medium) |
...
- [ ] Evidence note at `docs/v3.11.0/development/roster-verification.md` with primary-source citations and per-platform recommended actions
...
- [ ] `docs/v3.11.0/known-gaps.md` created: S8 deferral, three carried v3.10.0 items, agent-disclosure divergence note, any Phase 3/5 no-go records
