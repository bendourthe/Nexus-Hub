...
- **Phase 4 (consolidation): declines, CHANGELOG, and validation sweep.** Record the policy-relevant declines in `docs/v3.11.0/known-gaps.md`, add the `## [Unreleased]` CHANGELOG entry, and run the full validator chain.
...
| 4 | Declines, CHANGELOG, and validation sweep (consolidation) | Policy-relevant declines recorded in `docs/v3.11.0/known-gaps.md`; `## [Unreleased]` CHANGELOG entry; full validator chain green | Strong reasoning tier, medium effort (Claude Code: Opus 4.8, medium) |
...
- [ ] All sub-tasks completed
- [ ] Declines recorded in `docs/v3.11.0/known-gaps.md` with the MCP Registry Policy cited
