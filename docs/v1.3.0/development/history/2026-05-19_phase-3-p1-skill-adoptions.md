...
- **Prior session reference**: [docs/v1.3.0/development/history/2026-05-19_phase-2-p0-skill-adoptions.md](2026-05-19_phase-2-p0-skill-adoptions.md)
- **Plan reference**: [docs/v1.3.0/plans/adoption-pm-claude-skills.md](../../plans/adoption-pm-claude-skills.md), Phase 3 sub-tasks 3.1-3.3 (lines 201-261).
- **Placement reference**: [docs/v1.3.0/plans/audit-category-placement.md](../../plans/audit-category-placement.md) -- confirms `architecture/` for `architecture-decision-record` and `tests-generation/` for `test-strategy-doc`.
