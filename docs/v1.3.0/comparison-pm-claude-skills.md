...
- **Documented version history** (`docs/v0.8.1/` through `docs/v1.3.0/`) with per-version plans, comparisons, known-gaps tracking.
...
| MCP registry policy | Documented in `AGENTS.md` + matrix in `docs/v1.0.0/` | No MCPs registered | DevAI-Hub-only |
