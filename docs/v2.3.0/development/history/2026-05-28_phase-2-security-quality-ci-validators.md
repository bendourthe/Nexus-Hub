...
- no-personal-paths: `--exclude docs/v2.0.0 --exclude docs/v2.1.0 --exclude docs/v2.2.0 --exclude catalog/hooks/tests`
- unicode-safety: `--exclude docs/v2.0.0 --exclude docs/v2.1.0 --exclude docs/v2.2.0 --exclude templates/ai-instructions`
...
- `python scripts/validate_no_personal_paths.py --exclude docs/v2.0.0 --exclude docs/v2.1.0 --exclude docs/v2.2.0 --exclude catalog/hooks/tests` -- exit 0
- `python scripts/validate_unicode_safety.py --exclude docs/v2.0.0 --exclude docs/v2.1.0 --exclude docs/v2.2.0 --exclude templates/ai-instructions` -- exit 0, 1034 warnings (em-dashes in `templates/development/compliance-review/`, recorded as WN-v23-3)
...
Four new entries appended to `docs/v2.3.0/known-gaps.md`:
...
- `docs/v2.3.0/development/history/2026-05-28_phase-2-security-quality-ci-validators.md` (this file)
...
- `docs/v2.3.0/known-gaps.md` (updated header status, summary counts, three new open items)
