...
**Source comparison**: [docs/v2.3.0/comparison-superpowers.md](../comparison-superpowers.md)
**Sibling plan (untouched)**: [docs/v2.3.0/plans/adoption-ecc-cybersec-skills.md](adoption-ecc-cybersec-skills.md)
...
No constitution file found at docs/v2.3.0/constitution.md - skipping check. Recommend running /constitution to establish project principles.
...
**Prompt**:
> Create `catalog/skills/workflow/verification-before-completion/SKILL.md`. This is a discipline-enforcing skill adapted from the pattern documented in `docs/v2.3.0/comparison-superpowers.md` Section 5a (source pattern: superpowers `skills/verification-before-completion/SKILL.md`). Do NOT copy the source verbatim or use its "your human partner" voice (comparison report N2); write it in Nexus-Hub's professional teaching tone.
...
**Prompt**:
> Create `catalog/skills/code-review/receiving-code-review/SKILL.md`. Adapt the pattern in `docs/v2.3.0/comparison-superpowers.md` Section 5a (source: superpowers `skills/receiving-code-review/SKILL.md`); adapt, do not copy (N2), and use Nexus-Hub voice.
...
**Prompt**:
> Create `catalog/skills/workflow/using-git-worktrees/SKILL.md`. Adapt the pattern in `docs/v2.3.0/comparison-superpowers.md` Section 5a (source: superpowers `skills/using-git-worktrees/SKILL.md`); adapt to Nexus-Hub voice, do not copy (N2).
...
**Prompt**:
> Create `catalog/skills/workflow/create-custom-command/references/persuasion-principles.md`. Adapt the content in `docs/v2.3.0/comparison-superpowers.md` Section 4 (source: superpowers `skills/writing-skills/persuasion-principles.md`); adapt to Nexus-Hub voice, do not copy (N2).
...
**Prompt**:
> Enhance `catalog/skills/bug-fixing/regression-root-cause-analyzer/SKILL.md` with the discipline framing documented in `docs/v2.3.0/comparison-superpowers.md` Section 5a (source: superpowers `skills/systematic-debugging/SKILL.md`); adapt, do not copy (N2).
...
**Prompt**:
> Create `catalog/skills/tests-generation/flaky-test-detector/references/condition-based-waiting.md`. Adapt from `docs/v2.3.0/comparison-superpowers.md` Section 5a (source: superpowers `skills/systematic-debugging/condition-based-waiting.md`); adapt, do not copy (N2).
...
**Prompt**:
> Enhance `catalog/skills/developer-experience/spec-driven-development/SKILL.md` (and cross-link `catalog/skills/developer-experience/idea-refine/SKILL.md`) with the hard-gate pattern from `docs/v2.3.0/comparison-superpowers.md` Section 5a (source: superpowers `skills/brainstorming/SKILL.md`); adapt, do not copy (N2).
...
**Prompt**:
> Extend `scripts/optimize_skill_description.py` (and any helper it uses) to detect "premature action" in a `with_skill` run: parse the run's tool-invocation stream and flag any non-`Skill`, non-`TodoWrite` tool use that occurs before the first `Skill` invocation. Surface this per-eval as a boolean `premature_action` field in the grading/benchmark output. Adapt the technique from `docs/v2.3.0/comparison-superpowers.md` Section 8 (source: superpowers `tests/explicit-skill-requests/run-test.sh`). Constraint: reuse the existing CLI-adapter dispatcher (claude/gemini/codex/opencode) - no new outbound calls, no new dependency; the harness uses the user's already-configured model CLI exactly as today. Preserve the existing optimizer behavior and CLI-parity invariant.
