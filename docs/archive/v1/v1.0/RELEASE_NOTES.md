...
The full plan that drove this release is at [docs/archive/v1/v1.0/plans/security-hardening-v100.md](plans/security-hardening-v100.md). The authoritative MCP classification document is [docs/policy/mcp-reverse-engineering-matrix.md](mcp-reverse-engineering-matrix.md).
...
- **Plan**: [docs/archive/v1/v1.0/plans/security-hardening-v100.md](plans/security-hardening-v100.md)
