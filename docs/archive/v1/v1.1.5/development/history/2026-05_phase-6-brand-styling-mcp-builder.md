...
- `docs/archive/v1/v1.1.5/known-gaps.md` updated: summary table 9 -> 10 open items, DF count 6 -> 7; new DF-007 entry covering the deferred end-to-end exercise of the four mcp-builder scaffolders against real Python 3.10+ / Node 20+ hosts; Last updated stamped 2026-05-08 (Phase 6 complete).
...
- This session-history file authored at `docs/archive/v1/v1.1.5/development/history/2026-05_phase-6-brand-styling-mcp-builder.md`.
