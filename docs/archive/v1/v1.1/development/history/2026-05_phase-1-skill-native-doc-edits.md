...
**Objective**: Execute Phase 1 of the v1.1.5 `adoption-skills` plan ([docs/archive/v1/v1.1/plans/adoption-skills.md](../../plans/adoption-skills.md)). Five doc-only edits (A14, A17, A15, A11, A12) that institutionalize patterns observed in upstream skill-authoring guidance, without adding any new file to the catalog file tree.
...
- **Plan reference**: [docs/archive/v1/v1.1/plans/adoption-skills.md](../../plans/adoption-skills.md) (authoritative 7-phase plan, 17 adoption items A1-A17)
- **Comparison reference**: [docs/archive/v1/v1.1/comparison-skills.md](../../comparison-skills.md) (the upstream comparison report that produced the 17 adoption items)
