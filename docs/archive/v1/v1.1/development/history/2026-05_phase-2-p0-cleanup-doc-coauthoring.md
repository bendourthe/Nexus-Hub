...
**Objective**: Execute Phase 2 of the v1.1.5 `adoption-skills` plan ([docs/archive/v1/v1.1/plans/adoption-skills.md](../../plans/adoption-skills.md)). Two scope items: (A4) resolve the `claude-api` skill index drift, and (A9) ship a new `doc-coauthoring` workflow skill that wraps the 3-stage co-authoring pattern.
...
- **Prior session reference**: [docs/archive/v1/v1.1/development/history/2026-05_phase-1-skill-native-doc-edits.md](2026-05_phase-1-skill-native-doc-edits.md)
- **Plan reference**: [docs/archive/v1/v1.1/plans/adoption-skills.md](../../plans/adoption-skills.md) Phase 2 (sub-tasks 2.1, 2.2, 2.3, 2.4)
