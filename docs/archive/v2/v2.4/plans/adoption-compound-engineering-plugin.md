...
- Comparison: [docs/archive/v2/v2.3/comparison-compound-engineering-plugin.md](../../v2.3.0/comparison-compound-engineering-plugin.md) (Adoption Plan Section 11; Security/RE Assessment Section 9).
- Ingested gaps: [docs/archive/v2/v2.3/known-gaps.md](../../v2.3.0/known-gaps.md) (all 15 open items).
