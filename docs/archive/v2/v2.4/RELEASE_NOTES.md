...
Four live-verification gaps were re-deferred with dated reasons (all acceptable for a source release, recorded in [`docs/archive/v2/v2.4/known-gaps.md`](known-gaps.md)):
