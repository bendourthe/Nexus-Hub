...
**Date**: 2026-05-26
**Plan**: [docs/archive/v2/v2.2.0/plans/adoption-antigravity-sdk-python.md](../../plans/adoption-antigravity-sdk-python.md)
...
| T004 | Probe refinement | Added Section 7 to `docs/archive/v2/v2.2.0/antigravity-cli-probe.md` pinning four backend-runtime fields (default model `gemini-3.5-flash`, app data dir `~/.gemini/antigravity/brain/`, MCP transport stdio + SSE, default policy `confirm_run_command()`) to `(documented, SDK v0.1.1)` with citations to the new skill's references; added the top-of-file update note; renumbered trailing sections 7-9 -> 8-10. |
...
- `docs/archive/v2/v2.2.0/development/history/2026-05-26_sdk-phase-1-core-adoption.md` (this file)
- `docs/archive/v2/v2.2.0/docs-cleanup-report-sdk-phase1.md`

## Files modified

- `docs/archive/v2/v2.2.0/antigravity-cli-probe.md` -- new Section 7 + update note + section renumber.
...
- `docs/archive/v2/v2.2.0/plans/adoption-antigravity-sdk-python.md` -- T001-T007 + Phase 1 Exit Checklist marked.
...
No new gaps. `docs/archive/v2/v2.2.0/known-gaps.md` (finalized in the codegraph plan's Phase 6) is left untouched; the plan's own close-out note is Phase 3 sub-task T017. Candidates A3-A8 are Phase 2 / Phase 3 scope of this plan, not gaps.
