...
| T017 | known-gaps close-out | `docs/archive/v2/v2.2.0/known-gaps.md` Status + Last-updated lines updated with the plan close-out summary; no new gaps; summary table counts unchanged (no deferrals -- N1-N4 are policy rejections). This session history generated. |
...
- `docs/archive/v2/v2.2.0/development/history/2026-05-26_sdk-phase-3-cross-link-polish.md` (this file)
- `docs/archive/v2/v2.2.0/docs-cleanup-report-sdk-phase3.md`
...
- `docs/archive/v2/v2.2.0/known-gaps.md` -- plan close-out note.
- `docs/archive/v2/v2.2.0/plans/adoption-antigravity-sdk-python.md` -- T013-T017 + Phase 3 Exit Checklist marked.
...
2. Combined release prep: rebaseline AGENTS.md catalog count to 207 skills, add the `google-antigravity-sdk` skill to `docs/archive/v2/v2.2.0/RELEASE_NOTES.md` and the `CHANGELOG.md` [2.2.0] block.
