...
- Two bugs surfaced and fixed inline (both Resolved entries in `docs/archive/v2/v2.2.0/known-gaps.md`):
...
- **DF-001** (carried forward to v2.3.0 as DF-001-part2): instruction-file byte parity gates T021's legacy bash block removal. Precise next-step list in `docs/archive/v2/v2.2.0/known-gaps.md`.
