...
- `docs/archive/v2/v2.3.0/development/history/2026-05-28_phase-4-installer-lifecycle.md` (this file)
...
- `docs/archive/v2/v2.3.0/known-gaps.md` (Status line advanced to "Phases 1-4 of 9 closed"; Last updated line records the Phase 4 close; Summary annotated as unchanged)
- `docs/archive/v2/v2.3.0/plans/adoption-ecc-cybersec-skills.md` (checked T010-T013 off and the Phase 4 Exit Checklist; flagged Phase 4 as "done" in Phases at a Glance)
...
- `docs/archive/v2/v2.3.0/development/history/2026-05-28_phase-3-runtime-learning.md` (redacted three pre-existing personal-path occurrences)
