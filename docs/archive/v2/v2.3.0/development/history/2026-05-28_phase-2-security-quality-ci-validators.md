...
**Date**: 2026-05-28
**Plan**: [docs/archive/v2/v2.3.0/plans/adoption-ecc-cybersec-skills.md](../../plans/adoption-ecc-cybersec-skills.md)
...
- no-personal-paths: `--exclude docs/archive/v2/v2.0.0 --exclude docs/archive/v2/v2.1.0 --exclude docs/archive/v2/v2.2.0 --exclude catalog/hooks/tests`
- unicode-safety: `--exclude docs/archive/v2/v2.0.0 --exclude docs/archive/v2/v2.1.0 --exclude docs/archive/v2/v2.2.0 --exclude templates/ai-instructions`
...
- `python scripts/validate_no_personal_paths.py --exclude docs/archive/v2/v2.0.0 --exclude docs/archive/v2/v2.1.0 --exclude docs/archive/v2/v2.2.0 --exclude catalog/hooks/tests` -- exit 0
- `python scripts/validate_unicode_safety.py --exclude docs/archive/v2/v2.0.0 --exclude docs/archive/v2/v2.1.0 --exclude docs/archive/v2/v2.2.0 --exclude templates/ai-instructions` -- exit 0, 1034 warnings (em-dashes in `templates/development/compliance-review/`, recorded as WN-v23-3)
...
Four new entries appended to `docs/archive/v2/v2.3.0/known-gaps.md`:
...
- `docs/archive/v2/v2.3.0/development/history/2026-05-28_phase-2-security-quality-ci-validators.md` (this file)
...
- `docs/archive/v2/v2.3.0/known-gaps.md` (updated header status, summary counts, three new open items)
