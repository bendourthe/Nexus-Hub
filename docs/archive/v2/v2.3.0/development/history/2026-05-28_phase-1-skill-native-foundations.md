...
- Validation results:
    ...
    - Strict full-catalog validator surfaces 7 pre-existing false-positive "Generic secret assignment" hits across 4 unrelated skills (`google-antigravity-sdk`, `user-documentation`, `cd-pipeline-generator`, `rollback-strategy-advisor`); none are Phase 1 introductions. Captured as `BG-v23-1` in `docs/archive/v2/v2.3.0/known-gaps.md`.
...
Two entries in `docs/archive/v2/v2.3.0/known-gaps.md`:
