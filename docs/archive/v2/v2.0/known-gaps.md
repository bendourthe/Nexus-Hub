...
**Plan**: [docs/archive/v2/v2.0/plans/nexus-hub-rename.md](plans/nexus-hub-rename.md)
**Status**: finalized
...
**Plan reference**: [docs/archive/v2/v2.0/plans/nexus-hub-rename.md](plans/nexus-hub-rename.md) sub-task 6.3 and Phase 6.4 stability gate step 1 ("matches are allowed only inside an explicit 'renamed from' / migration callout block"). [docs/archive/v2/v2.0/rename-decisions.md](rename-decisions.md) version-semantics rule -- historical CHANGELOG-style content is preserved as-is to reflect the release as it happened.
