...
| `docs/archive/v2/v2.0.0/baselines/*` | Pre-rename validator baselines captured at Phase 1.1; intentionally contain the old names to document the starting state. |
| `docs/archive/v2/v2.0.0/installer-smoke-pre.txt` | Pre-migration smoke capture. |
| `docs/archive/v2/v2.0.0/rename-inventory.md` | The rename inventory itself; the "from" column needs the old names. |
| `docs/archive/v2/v2.0.0/rename-decisions.md` | The naming canon decision record; documents both old and new names by construction. |
| `docs/archive/v2/v2.0.0/rename-manifest.txt` | Output of `scripts/apply_rename.py` from Phase 5.1. |
| `docs/archive/v2/v2.0.0/plans/nexus-hub-rename.md` | The plan document; references the old name when describing the rename surface. |
| `docs/archive/v2/v2.0.0/development/history/*` | Phase-by-phase history records; intentional historical narrative. |
...
- `CHANGELOG.md` v2.0.0 block and `docs/archive/v2/v2.0.0/RELEASE_NOTES.md` are authored in sub-task 7.5.
