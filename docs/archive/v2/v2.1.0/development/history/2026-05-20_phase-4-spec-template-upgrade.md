...
**Date**: 2026-05-20
**Scope**: Phase 4 of [docs/archive/v2/v2.1.0/plans/adoption-spec-kit.md](../../plans/adoption-spec-kit.md)
...
**Plan reference**: [docs/archive/v2/v2.1.0/plans/adoption-spec-kit.md](../../plans/adoption-spec-kit.md) Phase 4
...
| `docs/archive/v2/v2.1.0/known-gaps.md` | Phase-4-close `Last updated` line refreshed; no new open items, no resolved items |
| `docs/archive/v2/v2.1.0/development/history/2026-05-20_phase-4-spec-template-upgrade.md` | This file (session history) |
