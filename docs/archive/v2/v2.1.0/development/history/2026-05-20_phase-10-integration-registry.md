...
**Date**: 2026-05-20
**Phase**: 10 of `docs/archive/v2/v2.1.0/plans/adoption-spec-kit.md`
...
1. **ADR-001** (`docs/archive/v2/v2.1.0/adr/adr-001-integration-registry.md`) -- 5 sections, 5 alternatives considered and rejected.
