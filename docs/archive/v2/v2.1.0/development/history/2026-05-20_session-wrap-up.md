...
Single-session implementation of Phase 10 (Integration Registry refactor) of `docs/archive/v2/v2.1.0/plans/adoption-spec-kit.md`, plus the expanded-platform support request (Windsurf, Antigravity 2.0, Gemini CLI, Nexus-AI), plus post-implementation maintenance (docs archive, gitignore, README sync).
...
- `docs/archive/v2/v2.1.0/adr/adr-001-integration-registry.md`
...
- `docs/archive/v2/v2.1.0/development/history/2026-05-20_phase-10-integration-registry.md`
- `docs/archive/v2/v2.1.0/development/history/2026-05-20_session-wrap-up.md` (this file)
...
- `docs/archive/v2/v2.1.0/RELEASE_NOTES.md` (Phase 10 addendum + 11-row platform table)
- `docs/archive/v2/v2.1.0/known-gaps.md` (DF-001: byte-identical parity migration deferred to v2.2.0)
...
3. **v2.2.0**: implement DF-001 -- write `tests/integrations/test_parity_with_legacy_installer.py` that diffs the legacy installer output against the registry output for the original 4 platforms, then refactor the installers to delegate those four through the runner. ADR-001 (`docs/archive/v2/v2.1.0/adr/adr-001-integration-registry.md`) sketches the migration plan in its alternatives section.
