...
**Status**: Accepted
**Date**: 2026-05-20
**Targets**: v2.1.0 (Phase 10 of `docs/archive/v2/v2.1.0/plans/adoption-spec-kit.md`)
...
- `docs/archive/v2/v2.1.0/plans/adoption-spec-kit.md` -- the plan that introduced Phase 10
