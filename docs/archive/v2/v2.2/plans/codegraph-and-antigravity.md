...
**Created**: 2026-05-21
**Goal**: Adopt every CodeGraph capability surfaced in [docs/archive/v2/v2.1/comparison-codegraph.md](../../v2.1.0/comparison-codegraph.md) (14 items across P0/P1/P2/P3) and complete the Gemini-CLI-to-Antigravity-CLI transition before the 2026-06-18 sunset, leaving v2.2.0 ready to ship as a SemVer minor release.
...
- [ ] Legacy installer copy blocks removed *(deferred with T021 to v2.3.0; see DF-001 in [docs/archive/v2/v2.2/known-gaps.md](../../known-gaps.md))*
- [x] Session history generated for this phase
...
**Prompt**:
> Create docs/archive/v2/v2.2/RELEASE_NOTES.md. Open with a 3-paragraph narrative: paragraph 1 frames v2.2.0 as adopting 12 of 14 CodeGraph capabilities surfaced in [docs/archive/v2/v2.1/comparison-codegraph.md](../v2.1.0/comparison-codegraph.md); paragraph 2 frames the Gemini-CLI-to-Antigravity-CLI transition (cite the 2026-05-21 Google announcement) and confirms the transition shipped ahead of the 2026-06-18 sunset; paragraph 3 surfaces what is DEFERRED (C13 standalone runtime bundling and C3-extended remaining framework extractors -> v2.3.0). Then a "Highlights" section with 5-8 bullet points written from the user perspective ("Your Nexus-Hub installer can now run `--check` to detect drift without writing a byte", "`nexus-code-search` answers `callers(...)` / `callees(...)` / `impact(...)` against a tree-sitter AST graph"). Then a "Per-candidate adoption map" table mapping each comparison candidate (C1, C2, ..., C14) to the sub-task IDs that shipped it (T001, T002, ..., T034). Cross-link to the plan file [docs/archive/v2/v2.2/plans/codegraph-and-antigravity.md](plans/codegraph-and-antigravity.md), the comparison report, and the CHANGELOG entry.
