...
**Date**: 2026-06-18
**Version**: v3.8.0
**Plan**: [docs/v3/v3.8/plans/adoption-ralph-claude-code.md](../../plans/adoption-ralph-claude-code.md)
**Comparison**: [docs/v3/v3.8/comparisons/v3.8.0-comparison-ralph-claude-code.md](../../comparison-ralph-claude-code.md)
...
- Closed two carried-forward known gaps: WN-v37-3 (`README_zh` counts) and WN-v33-2 (two over-limit `overview_l1` fields). See [docs/v3/v3.8/known-gaps.md](../../known-gaps.md).
