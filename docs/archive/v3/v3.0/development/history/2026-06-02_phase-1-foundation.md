...
See [`docs/v3/v3.0/known-gaps.md`](../../known-gaps.md). One open item: WN-v30-1 (local lint verification partial; ShellCheck deferred to CI; low severity, covered by CI).
