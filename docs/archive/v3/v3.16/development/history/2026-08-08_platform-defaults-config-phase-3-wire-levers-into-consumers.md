...
BG-2, BG-3, DF-3, QG-2 closed in-phase; NI-2 resolved. NI-5 (four declared-but-not-writable platforms) and NI-6 (hermes is seedable but not installed by default) opened. Recorded in [docs/v3/v3.16/known-gaps.md](../../known-gaps.md).
