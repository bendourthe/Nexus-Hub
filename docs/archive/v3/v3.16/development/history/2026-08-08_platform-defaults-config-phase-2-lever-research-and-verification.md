...
QG-1 (closed in-phase), NI-2 (`copilot` surface mismatch), NI-3 (`~/.gemini` shared home), NI-4 (the four UNVERIFIED platforms awaiting a Phase 5.2 disposition), plus five observations. Recorded in [docs/v3/v3.16/known-gaps.md](../../known-gaps.md).
