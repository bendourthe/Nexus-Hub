...
See [`docs/v3/v3.4/known-gaps.md`](../../known-gaps.md). No new gaps introduced this phase. WN-v33-1 re-confirmed and updated to record that Phase 4 shipped `.sh`/`.ps1` edits verified by `bash -n` + the PowerShell AST parser (ShellCheck unavailable locally; CI runs it). DF-v34-1 and WN-v33-2 carried forward, untouched.
