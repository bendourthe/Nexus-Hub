...
>
> **Successor plan**: [`docs/archive/v1/v1.0/plans/security-hardening-v100.md`](../../v1.0.0/plans/security-hardening-v100.md) (generated via `/generate-plan` from the v1.0.0 scratch plan — see that file's Phase 0 for the authoring trail).
>
