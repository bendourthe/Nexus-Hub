...
- `docs/v3.5.0/plans/adoption-loopmaxxing-and-autoresearch.md` (Phase 2 exit checklist)
- `docs/v3.5.0/development/history/2026-06-15_adoption-loopmaxxing-and-autoresearch-phase-2-metric-optimization-archetype-and-oracle-carve-out.md` (this file)
