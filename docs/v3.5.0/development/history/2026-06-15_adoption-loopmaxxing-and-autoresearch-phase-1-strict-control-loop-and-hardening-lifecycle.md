...
- `docs/v3.5.0/plans/adoption-loopmaxxing-and-autoresearch.md` (Phase 1 exit checklist)
- `docs/v3.5.0/development/history/2026-06-15_adoption-loopmaxxing-and-autoresearch-phase-1-strict-control-loop-and-hardening-lifecycle.md` (this file)
