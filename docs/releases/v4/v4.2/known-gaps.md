...
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.0-interactive-guide-redesign.md` T001
...
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.0-interactive-guide-redesign.md` T033
...
- **Source phase**: Phase 7 - Architecture refactor, known-gaps, CI/CD
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.1-guide-visual-education.md` T024
...
- **Source phase**: Phase 7 - Architecture refactor, known-gaps, CI/CD
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.1-guide-visual-education.md` T025
...
- **Source phase**: Phase 7 - Architecture refactor, known-gaps, CI/CD
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.2-guide-cinematic-rebuild.md` T027
...
- **Source phase**: Phase 1 - Design brief, design system, shell, and render harness
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.2-guide-cinematic-rebuild.md` T002
...
- **Plan reference**: `docs/archives/v4/v4.2/plans/v4.2.3-guide-refinement.md` T031
