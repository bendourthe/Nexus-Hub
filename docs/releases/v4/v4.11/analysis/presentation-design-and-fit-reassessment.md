...
**Companions**: [Implementation plan](../../../../archives/v4/v4.11/plans/v4.11.0-interactive-handbooks-and-presentation-default.md), [earlier failure analysis](document-generation-failure-analysis.md), [reference study](interactive-handbooks-source-analysis.md).
