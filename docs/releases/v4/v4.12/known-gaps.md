...
**Owner**: Repository owner and publication operator. **Suggested next step**: at `2026-09-15T23:15:00Z (September 15, 4:15 PM America/Los_Angeles)`, recheck the Code sidebar and record its displayed count and account names. Insights is already confirmed by the user's screenshot. GitHub documents about 24 hours for contributor displays to refresh after history changes and recommends contacting GitHub Support if they remain incorrect after that window. See [GitHub's stale-contributor guidance](https://docs.github.com/en/repositories/viewing-activity-and-data-for-your-repository/viewing-a-projects-contributors#contributor-data-is-stale-after-history-changes). No further history rewrite is warranted by the current evidence; retain the screenshots and publication receipts for any support request. Existing releases and assets are already verified unchanged. No follow-up is automatically scheduled, and no public-view success or release completion is claimed.
