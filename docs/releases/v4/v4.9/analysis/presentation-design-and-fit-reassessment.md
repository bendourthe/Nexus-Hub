...
**Companions**: [Implementation plan](../plans/v4.9.2-interactive-handbooks-and-presentation-default.md), [earlier failure analysis](document-generation-failure-analysis.md), [reference study](interactive-handbooks-source-analysis.md).
