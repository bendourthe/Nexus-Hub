...
The full plan that drove this release is at [docs/v1.0.0/plans/security-hardening-v100.md](plans/security-hardening-v100.md). The authoritative MCP classification document is [docs/v1.0.0/mcp-reverse-engineering-matrix.md](mcp-reverse-engineering-matrix.md).
...
[`docs/v1.0.0/mcp-reverse-engineering-matrix.md`](mcp-reverse-engineering-matrix.md) is the authoritative classification document for every MCP shipped or considered. 18 rows organized into five sections:
...
**Migration**: users who relied on these can re-add them to their own `.claude/settings.json`; DevAI-Hub no longer ships the snippets. The matrix at [docs/v1.0.0/mcp-reverse-engineering-matrix.md](mcp-reverse-engineering-matrix.md) documents the decision per-row.
...
- **Plan**: [docs/v1.0.0/plans/security-hardening-v100.md](plans/security-hardening-v100.md)
- **Matrix**: [docs/v1.0.0/mcp-reverse-engineering-matrix.md](mcp-reverse-engineering-matrix.md)
