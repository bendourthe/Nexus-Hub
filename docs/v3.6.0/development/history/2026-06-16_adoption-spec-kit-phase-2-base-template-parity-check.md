...
- **Diff isolation**: confirmed `git status` shows exactly the intended surfaces -- `scripts/check_base_template_parity.py`, `tests/validators/test_check_base_template_parity.py`, `Makefile`, `.github/workflows/ci.yml`, `AGENTS.md`, plus the plan checklist, this session history, and `docs/v3.6.0/known-gaps.md`. No scope creep, no registry edit, no installer edit.
...
- `docs/v3.6.0/plans/adoption-spec-kit.md` (Phase 2 exit checklist checked off)
- `docs/v3.6.0/known-gaps.md` (new; WN-v33-1 carried forward + new WN-v36-1 + WN-v33-2)
- `docs/v3.6.0/development/history/2026-06-16_adoption-spec-kit-phase-2-base-template-parity-check.md` (this file)
