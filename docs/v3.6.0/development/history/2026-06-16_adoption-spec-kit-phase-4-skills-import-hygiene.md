...
- `docs/v3.6.0/plans/adoption-spec-kit.md` (Phase 4 exit checklist checked off; Phase-3-pending note)
- `docs/v3.6.0/known-gaps.md` (NI-v36-1 added for pending Phase 3; WN-v33-1 + WN-v36-1 re-confirmed for Phase 4)
- `docs/DEVLOG.md` (Phase 4 entry)
- `docs/v3.6.0/development/history/2026-06-16_adoption-spec-kit-phase-4-skills-import-hygiene.md` (this file)
