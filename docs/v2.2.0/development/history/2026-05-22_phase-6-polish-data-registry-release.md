...
**Date**: 2026-05-22
**Plan**: [docs/v2.2.0/plans/codegraph-and-antigravity.md](../../plans/codegraph-and-antigravity.md) Phase 6
**Phase**: 6 of 6 (FINAL)
...
2. **T038 ran Windows-only.** No macOS VM or Docker macOS-mode container was available on the Phase 6 host. Inferred PASS-by-parity for macOS / Linux is documented in `docs/v2.2.0/installer-smoke-post.txt` sections 2 and 3, and as known-gap `WN-8`. The deferral is acceptable for a source release.
...
- **WN-8**: Phase 6 cross-OS installer smoke ran only on Windows; macOS and Linux not yet re-verified. Tracked at `docs/v2.2.0/known-gaps.md` for re-run before any v2.2.0-tagged binary release.
...
- `docs/v2.2.0/known-gaps.md` -- status finalized; Phase 6 close summary; WN-8 added; DF-001 part 1 added to Resolved; summary table re-tallied.
...
**New (4)**:
- `docs/v2.2.0/RELEASE_NOTES.md` -- v2.2.0 user-facing narrative + per-candidate adoption map.
- `docs/v2.2.0/installer-smoke-post.txt` -- cross-OS smoke results (Windows PASS, macOS / Linux deferred).
- `docs/v2.2.0/docs-cleanup-report-phase6.md` -- audit-only docs cleanup report for Phase 6.
- `docs/v2.2.0/development/history/2026-05-22_phase-6-polish-data-registry-release.md` -- this file.
