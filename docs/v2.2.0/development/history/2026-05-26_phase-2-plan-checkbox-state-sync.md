...
|---|---|---|
| T007 | `docs/v2.2.0/antigravity-cli-probe.md` (94 lines, static probe with explicit documented / inferred / open tagging) | yes |
...
| T012 | `docs/v2.2.0/antigravity-cli-commands-schema.md` (102 lines); concludes Antigravity 2.0 + CLI uses Markdown verbatim under `~/.agent/workflows/` (vs. Gemini CLI's `.toml` schema under `~/.gemini/commands/`); the existing `SkillsIntegration._mirror_catalog` covers both branches -- no `_write_antigravity_commands` variant required | yes |
...
| T014 | `docs/v2.2.0/development/history/2026-05-21_phase-2-gemini-to-antigravity-cli-transition.md` exists; targeted test suite passes (re-verified this session) | yes |
