...
- `docs/v2.2.0/eval-baseline.md`
- `docs/v2.2.0/docs-cleanup-report-phase5.md`
- `docs/v2.2.0/development/history/2026-05-22_phase-5-code-graph-capabilities.md` (this file)
...
- `Makefile` -- add `make eval` target wired to `docs/v2.2.0/eval-baseline.md`
- `docs/v2.2.0/known-gaps.md` -- log Phase 5 close + new WN-7 gap (FTS5 precision)
...
Phase 6 (Polish, data-registry rebaseline, and release) is now unblocked. It runs the cross-OS installer smoke, authors `docs/v2.2.0/RELEASE_NOTES.md` and the CHANGELOG `[2.2.0]` block, finalizes `docs/v2.2.0/known-gaps.md`, bumps version manifests, and prepares the `git tag v2.2.0` cut.
