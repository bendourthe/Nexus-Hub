...
- `docs/v2.2.0/development/history/2026-05-26_sdk-phase-2-pattern-references.md` (this file)
- `docs/v2.2.0/docs-cleanup-report-sdk-phase2.md`
...
- `docs/v2.2.0/plans/adoption-antigravity-sdk-python.md` -- T008-T012 + Phase 2 Exit Checklist marked.
...
No new gaps. `docs/v2.2.0/known-gaps.md` is left untouched; the plan's close-out note is Phase 3 (T017).
