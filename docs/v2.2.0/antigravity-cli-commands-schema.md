...
**Companion to**: [`docs/v2.2.0/antigravity-cli-probe.md`](antigravity-cli-probe.md)
...
- Probe: [docs/v2.2.0/antigravity-cli-probe.md](antigravity-cli-probe.md)
- Phase 2 plan reference: [docs/v2.2.0/plans/codegraph-and-antigravity.md](plans/codegraph-and-antigravity.md) sub-task 2.6 (T012)
