...
| Versioned-docs layout with v-MAJOR archive and known-gaps tracker | `docs/v2.2.0/`, `docs/archive/v0/v0.9.6/`, `docs/v2.2.0/known-gaps.md`, `catalog/skills/workflow/known-gaps-tracker/` | The SDK uses a flat docs structure. Nexus-Hub's versioning discipline is a load-bearing strength. |
| Project constitution + cross-artifact analyzer + spec-driven-development chain | `catalog/skills/workflow/project-constitution/`, `catalog/skills/code-review/cross-artifact-analyzer/`, `docs/v2.1.0/spec-driven-methodology.md` | Not present in the SDK. |
...
- Current project files: `AGENTS.md` (MCP Registry Policy + Per-skill Bundled Resources + Adding a New Skill), `CLAUDE.md`, `docs/v2.2.0/plans/codegraph-and-antigravity.md`, `docs/v2.2.0/antigravity-cli-probe.md`, `docs/v2.2.0/known-gaps.md`, `docs/policy/mcp-reverse-engineering-matrix.md`, `scripts/lib/integrations/antigravity.py`, `catalog/skills/ai-development/claude-agent-sdk/SKILL.md`.
