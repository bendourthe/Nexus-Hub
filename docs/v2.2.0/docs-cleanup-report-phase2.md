...
**Scope**: `docs/v2.2.0/` and adjacent version directories
...
| Cat 2 -- archive | 0 |
| Cat 3 -- stale-flag | 1 |
| Cat 4 -- active | 5 (under `docs/v2.2.0/`) |
...
## Cat 4 -- active (under `docs/v2.2.0/`)

| File | Owner phase |
|---|---|
| `docs/v2.2.0/antigravity-cli-probe.md` | Phase 2 / T007 (new this phase) |
| `docs/v2.2.0/antigravity-cli-commands-schema.md` | Phase 2 / T012 (new this phase) |
| `docs/v2.2.0/known-gaps.md` | Phase 1 (created), Phase 2 (appended) |
| `docs/v2.2.0/plans/codegraph-and-antigravity.md` | Phase 0 (plan source-of-truth) |
| `docs/v2.2.0/development/history/` | (history files added per phase by `/generate-session-history`) |
