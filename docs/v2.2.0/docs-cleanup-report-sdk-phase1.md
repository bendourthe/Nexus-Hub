...
| docs/v2.2.0/antigravity-cli-probe.md | 4 (active) | Modified -- new Section 7 (SDK-pinned runtime fields), top-of-file note, sections 7-9 renumbered to 8-10. |
...
| docs/v2.2.0/plans/adoption-antigravity-sdk-python.md | 4 (active) | Modified -- T001-T007 + Phase 1 Exit Checklist marked. |
| docs/v2.2.0/known-gaps.md | 4 (active) | Untouched. Release-finalized in the codegraph plan's Phase 6; this plan's close-out note is its own Phase 3 (T017). No new gaps surfaced. |
| docs/DEVLOG.md | 4 (active) | New [2026-05-26] SDK Phase 1 entry. |
| docs/v2.2.0/development/history/2026-05-26_sdk-phase-1-core-adoption.md | 4 (active) | New -- this phase's session history. |
| docs/v2.2.0/docs-cleanup-report-sdk-phase1.md | 4 (active) | This file. |
