...
mkdir -p .vscode
cp path/to/ai-templates/templates/test_development/vscode_config/*.json .vscode/
```
...
1. **GitHub Actions**: Copy workflow from templates
   ...
   cp path/to/ai-templates/templates/test_development/maintenance_cicd/.github/workflows/cpp-tests.yml .github/workflows/
   ```
