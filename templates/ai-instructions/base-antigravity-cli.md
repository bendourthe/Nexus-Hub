...
This file is a thin alias for `base-antigravity-20.md`. The Antigravity CLI and the Antigravity 2.0 desktop IDE share a backend and on-disk conventions per the 2026-05-21 Google Developers Blog announcement (`docs/archive/v2/v2.2.0/antigravity-cli-probe.md`), so the `Antigravity20Integration` in `scripts/lib/integrations/antigravity.py` covers both surfaces with a single class.
