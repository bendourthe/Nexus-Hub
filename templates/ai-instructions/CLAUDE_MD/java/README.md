# Java Project Template for Claude Code

A complete, modular template for Java/Spring Boot projects using Claude Code with optimized instruction loading.
...
|--------------|------------------|
| "Create a new Spring Boot project" | `project-setup` (if added) |
...
To add Java-specific skills, create:

```
.claude/skills/java/
├── project-setup/SKILL.md        # Spring Boot structure, pom.xml
├── code-standards/SKILL.md       # Java conventions, Checkstyle
├── testing-framework/SKILL.md    # JUnit 5, Mockito configuration
└── command-preferences/SKILL.md  # Maven/Gradle commands
```
