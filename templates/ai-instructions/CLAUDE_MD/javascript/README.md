# JavaScript/TypeScript Project Template for Claude Code

A complete, modular template for JavaScript/TypeScript projects using Claude Code with optimized instruction loading.
...
|--------------|------------------|
| "Create a new Node.js project" | `project-setup` (if added) |
| "Fix this function" | `interaction-principles`, `code-standards` |
...
To add JavaScript/TypeScript-specific skills, create:

```
.claude/skills/javascript/
├── project-setup/SKILL.md        # Node.js/React project structure
├── code-standards/SKILL.md       # ESLint, Prettier, naming conventions
├── testing-framework/SKILL.md    # Jest/Vitest configuration
└── command-preferences/SKILL.md  # npm/yarn commands
```
