...
Ask the user: "Where is your ai-templates skills catalog located? Please provide the path to the `claude-skills-catalog/` directory."

**Common locations:**
- `~/ai-templates/claude-skills-catalog/`
- `../ai-templates/claude-skills-catalog/`
...
- `python-cleanup` (or language-appropriate cleanup)
