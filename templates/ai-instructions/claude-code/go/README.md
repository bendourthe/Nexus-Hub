# Go Project Template for Claude Code

A complete, modular template for Go projects using Claude Code with optimized instruction loading.
...
|--------------|------------------|
| "Create a new Go project" | `project-setup` (if added) |
...
To add Go-specific skills, create:

```
.claude/skills/go/
├── project-setup/SKILL.md        # Go project layout, go.mod
├── code-standards/SKILL.md       # Go idioms, golangci-lint
├── testing-framework/SKILL.md    # go test, testify configuration
└── command-preferences/SKILL.md  # go commands
```
