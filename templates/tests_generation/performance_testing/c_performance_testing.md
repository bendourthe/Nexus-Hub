---
template_id: c_performance_testing
...
prerequisites:
  ...
  - tests_generation/mocks_fixtures/c_mocks_fixtures.md
related_templates:

  - tests_generation/code_coverage/c_code_coverage.md
tools:
...
gprof: profile
	./benchmark_prof
	gprof benchmark_prof gmon.out > ${OUTPUT_DIR}/exports/gprof_analysis.txt
...
jobs:
  performance:
    ...
    - name: Run benchmarks
      run: ./benchmark > ${OUTPUT_DIR}/exports/benchmark-results.txt

    - name: Run load tests
      run: ./load_test > ${OUTPUT_DIR}/exports/load-test-results.txt

    - name: Run stress tests
      run: ./stress_test > ${OUTPUT_DIR}/exports/stress-test-results.txt
