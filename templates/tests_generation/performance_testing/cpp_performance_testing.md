---
template_id: cpp_performance_testing
template_name: Performance Testing - Cpp
version: 1.0.0
...
related_templates:
  ...
  - tests_generation/code_coverage/cpp_code_coverage.md
tools:
  ...
  performance:
    ...
    - name: Run benchmarks
      run: |
        ...
        ./benchmarks --benchmark_format=console > ${OUTPUT_DIR}/exports/benchmark_results.txt

    - name: Run load tests
      run: ./build/load_test > ${OUTPUT_DIR}/exports/load_test_results.txt

    - name: Run stress tests
      run: ./build/stress_test > ${OUTPUT_DIR}/exports/stress_test_results.txt
