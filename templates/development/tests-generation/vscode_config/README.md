...
mkdir -p .vscode
cp templates/development/tests-generation/vscode_config/*.json .vscode/
```
...
- [GOOGLE_TEST_VSCODE_WORKFLOW.md](../GOOGLE_TEST_VSCODE_WORKFLOW.md)

- [COPILOT_QUICK_REFERENCE.md](../unit_tests/COPILOT_QUICK_REFERENCE.md)
