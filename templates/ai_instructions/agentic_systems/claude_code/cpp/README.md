...
A complete, modular template for C++ projects using Claude Code with optimized instruction loading.
...
|--------------|------------------|
| "Create a new C++ project" | `project-setup` (if added) |
...
```
.claude/skills/cpp/
├── project-setup/SKILL.md        # Modern C++ project structure, CMake
├── code-standards/SKILL.md       # C++ conventions, clang-tidy
├── testing-framework/SKILL.md    # Google Test/Catch2 configuration
└── command-preferences/SKILL.md  # cmake/make commands
```
