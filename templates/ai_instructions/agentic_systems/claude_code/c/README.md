...
```
.claude/skills/c/
├── project-setup/SKILL.md        # C project structure, CMakeLists.txt
├── code-standards/SKILL.md       # C conventions, cppcheck
├── testing-framework/SKILL.md    # Unity/CMocka configuration
└── command-preferences/SKILL.md  # make/cmake commands
```
